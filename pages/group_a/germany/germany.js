...
useEffect(() => {
    ...
    return (
      data.map((item, i) => {
          ...
          return (
            ...
            <Link href={`/group_a/germany/${item.even}`} key={item._id} 
  ...
  return (
    ...
    <div className="arena">
      ...
      { path === '/group_a/germany/germany' &&  <h2 className='text-center mb-2'>Team Germany</h2>}


      <div className="mantinel">
      
        { path === '/group_a/germany/germany' && showTeam(data.ger) } 
