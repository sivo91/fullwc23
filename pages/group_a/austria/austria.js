...
useEffect(() => {
    ...
    return (
      data.map((item, i) => {
          ...
          return (
            ...
            <Link href={`/group_a/austria/${item.even}`} key={item._id} 
  ...
  return (
    ...
    <div className="arena">
      ...
      { path === '/group_a/austria/austria' && <h2 className='text-center mb-2'>Team Austria</h2> }


      <div className="mantinel">
        { path === '/group_a/austria/austria' && showTeam(data.aus) } 
      </div>
