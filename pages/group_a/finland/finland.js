...
useEffect(() => {
    ...
    return (
      data.map((item, i) => {
          ...
          return (
            ...
            <Link href={`/group_a/finland/${item.even}`} key={item._id} 
  ...
  return (
    ...
    <div className="arena">
      ...
      { path === '/group_a/finland/finland' &&  <h2 className='text-center mb-2'>Team Finland</h2>}


      <div className="mantinel">

        { path === '/group_a/finland/finland' && showTeam(data.fin) } 
