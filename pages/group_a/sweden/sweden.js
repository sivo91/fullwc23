    ...
    return (
      data.map((item, i) => {
          ...
          return (
            ...
            <Link href={`/group_a/sweden/${item.even}`} key={item._id} 
  ...
  return (
    ...
    <div className="arena">
      ...
      <h3 className='text-center mb-1'>Group A</h3>
       ...
       { path === '/group_a/sweden/sweden' &&  <h2 className='text-center mb-2'>Team Sweden</h2>}


      <div className="mantinel">
       
        { path === '/group_a/sweden/sweden' && showTeam(data.swe) } 
